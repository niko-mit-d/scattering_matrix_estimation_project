function [x_hat, h_hat, P_plus] = run_PM_kalman(yk, tau, uk, param)
% Kalman filter using unitary constraints as perfect measurements
...
for i=2:param.sim.dim_t
    ...
    [h_hat(:,i-1), dhdx] = constraint_unitary(x_hat(:,i-1),param);
    H = [param.kal.C(:,:,k(i-1)); dhdx];
    y = [yk(:,i); dhdx*x_hat(:,i-1)-h_hat(:,i-1)];
